...
product = Product.new(
  ...
  category: "Phones & Mobile Tech",
  price: "45",
  accessoires: "USB-charger, screen protection, heavy-duty case",
  condition: "Like New",
  model: "iPhone 11 Pro",
  brand: "Apple",
...
product = Product.new(
  ...
  category: "Cameras",
  price: "25",
  accessoires: "SD 64GB, 18-25mm VR Zoom Lens Kit, two Nikon EN-EL14a Batteries with charger",
...
product = Product.new(
  ...
  category: "Computers",
  price: "30",
  accessoires: "16 GB RAM, 1 TB SSD Capacity, protective shell and charger included",
  condition: "Like New",
...
product = Product.new(
  ...
  category: "Phones & Mobile Tech",
  price: "45",
  accessoires: "128 GB Capacity, Apple Pencil and charger included",
...
product = Product.new(
  ...
  category: "Gaming",
  price: "7",
  accessoires: "Gamepad only (Playstation/chargers not included)",
  condition: "Normal Wear",
  model: "DualShock 4",
  brand: "Sony",
  delivery_method: "Delivery",
...
product = Product.new(
  ...
  category: "Phones & Mobile Tech",
  price: "47",
  accessoires: "AirPods, charger and protective Case included",
  condition: "Normal Wear",
  model: "iPhone 11 Pro",
  brand: "Apple",
  delivery_method: "Flexible",
...
product = Product.new(
  ...
  category: "Phones & Mobile Tech",
  price: "27",
  accessoires: "charger and Screenprotection included",
  condition: "Like New",
...
product = Product.new(
  ...
  category: "Cameras",
  price: "18",
  accessoires: "35mm lens, batteries, Nikon strap, Manual Book",
  condition: "Minor Cosmetic Faults",
  model: "F1",
  brand: "Nikon",
...
product = Product.new(
  ...
  category: "Cameras",
  price: "24",
  accessoires: "28-105 mm lens, two rechargeable batteries with charger, Camera strap",
  condition: "Normal Wear",
  model: "EOS 6D",
  brand: "Canon",
  delivery_method: "Flexible",
